	...
	public function ctrIngresoUsuario(){
		...
		if(isset($_POST["ingresoEmail"])){
			 ...
			 if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["ingresoEmail"]) && preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingresoPassword"])){
			 	...
			 	$respuesta = ModeloUsuarios::mdlMostrarUsuarios($tabla, $item, $valor);
				// desactiva temporalmente $encriptar por $_POST["ingresoEmail"] para acceder sin comparacion de clave encriptada
			 	if($respuesta["email"] == $_POST["ingresoEmail"] && $respuesta["password"] == $encriptar){

					// Si el campo "verificacion" de la tabla usuarios tiene el entero = 1 significa que ha verificado la cuenta mediante correo
